...
pa_channel_position_to_pretty_string = _libraries[
    "libpulse.so.0"
...
pa_channel_map_compatible.argtypes = [
    POINTER(pa_channel_map),
...
pa_channel_map_superset.argtypes = [
    POINTER(pa_channel_map),
    POINTER(pa_channel_map),
]
...
pa_channel_map_to_pretty_name = _libraries[
    "libpulse.so.0"
...
pa_channel_map_has_position.argtypes = [
    POINTER(pa_channel_map),
...
pa_context_set_event_callback = _libraries[
    "libpulse.so.0"
...
pa_context_set_default_source = _libraries[
    "libpulse.so.0"
...
pa_time_event_cb_t = CFUNCTYPE(
    None, POINTER(pa_mainloop_api), POINTER(pa_time_event), POINTER(timeval), c_void_p,
)
...
pa_context_get_tile_size.argtypes = [
    POINTER(pa_context),
    POINTER(pa_sample_spec),
]
...
pa_format_info_is_compatible.argtypes = [
    POINTER(pa_format_info),
    POINTER(pa_format_info),
]
...
pa_format_info_set_prop_int_array = _libraries[
    "libpulse.so.0"
].pa_format_info_set_prop_int_array
pa_format_info_set_prop_int_array.restype = None
pa_format_info_set_prop_int_array.argtypes = [
    POINTER(pa_format_info),
    STRING,
    POINTER(c_int),
    c_int,
]
pa_format_info_set_prop_int_range = _libraries[
    "libpulse.so.0"
].pa_format_info_set_prop_int_range
pa_format_info_set_prop_int_range.restype = None
pa_format_info_set_prop_int_range.argtypes = [
    POINTER(pa_format_info),
    STRING,
    c_int,
    c_int,
]
pa_format_info_set_prop_string = _libraries[
    "libpulse.so.0"
].pa_format_info_set_prop_string
pa_format_info_set_prop_string.restype = None
pa_format_info_set_prop_string.argtypes = [
    POINTER(pa_format_info),
    STRING,
    STRING,
]
pa_format_info_set_prop_string_array = _libraries[
    "libpulse.so.0"
].pa_format_info_set_prop_string_array
pa_format_info_set_prop_string_array.restype = None
pa_format_info_set_prop_string_array.argtypes = [
    POINTER(pa_format_info),
    STRING,
    POINTER(STRING),
    c_int,
...
pa_format_info_set_sample_format = _libraries[
    "libpulse.so.0"
].pa_format_info_set_sample_format
pa_format_info_set_sample_format.restype = None
pa_format_info_set_sample_format.argtypes = [
    POINTER(pa_format_info),
    pa_sample_format_t,
]
...
pa_format_info_set_channel_map = _libraries[
    "libpulse.so.0"
].pa_format_info_set_channel_map
pa_format_info_set_channel_map.restype = None
pa_format_info_set_channel_map.argtypes = [
    POINTER(pa_format_info),
    POINTER(pa_channel_map),
]
...
pa_context_set_sink_volume_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_set_sink_volume_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_set_sink_mute_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_set_sink_mute_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_suspend_sink_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_suspend_sink_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_set_sink_port_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_set_sink_port_by_name = _libraries[
    "libpulse.so.0"
...
pa_source_info_cb_t = CFUNCTYPE(
    None, POINTER(pa_context), POINTER(pa_source_info), c_int, c_void_p
)
pa_context_get_source_info_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_get_source_info_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_get_source_info_list = _libraries[
    "libpulse.so.0"
...
pa_context_set_source_volume_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_set_source_volume_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_set_source_mute_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_set_source_mute_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_suspend_source_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_suspend_source_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_set_source_port_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_set_source_port_by_name = _libraries[
    "libpulse.so.0"
...
pa_module_info_cb_t = CFUNCTYPE(
    None, POINTER(pa_context), POINTER(pa_module_info), c_int, c_void_p
)
...
pa_context_get_module_info_list = _libraries[
    "libpulse.so.0"
...
pa_client_info_cb_t = CFUNCTYPE(
    None, POINTER(pa_context), POINTER(pa_client_info), c_int, c_void_p
)
...
pa_context_get_client_info_list = _libraries[
    "libpulse.so.0"
...
pa_card_info_cb_t = CFUNCTYPE(
    None, POINTER(pa_context), POINTER(pa_card_info), c_int, c_void_p
)
pa_context_get_card_info_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_get_card_info_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_get_card_info_list = _libraries[
    "libpulse.so.0"
...
pa_context_set_card_profile_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_set_card_profile_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_get_sink_input_info = _libraries[
    "libpulse.so.0"
...
pa_context_get_sink_input_info_list = _libraries[
    "libpulse.so.0"
...
pa_context_move_sink_input_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_move_sink_input_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_set_sink_input_volume = _libraries[
    "libpulse.so.0"
...
pa_source_output_info_cb_t = CFUNCTYPE(
    None, POINTER(pa_context), POINTER(pa_source_output_info), c_int, c_void_p
)
pa_context_get_source_output_info = _libraries[
    "libpulse.so.0"
...
pa_context_get_source_output_info_list = _libraries[
    "libpulse.so.0"
...
pa_context_move_source_output_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_move_source_output_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_set_source_output_volume = _libraries[
    "libpulse.so.0"
...
pa_context_set_source_output_mute = _libraries[
    "libpulse.so.0"
...
pa_context_kill_source_output = _libraries[
    "libpulse.so.0"
...
pa_stat_info_cb_t = CFUNCTYPE(
    None, POINTER(pa_context), POINTER(pa_stat_info), c_void_p
)
...
pa_sample_info_cb_t = CFUNCTYPE(
    None, POINTER(pa_context), POINTER(pa_sample_info), c_int, c_void_p
)
pa_context_get_sample_info_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_get_sample_info_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_get_sample_info_list = _libraries[
    "libpulse.so.0"
...
pa_autoload_info_cb_t = CFUNCTYPE(
    None, POINTER(pa_context), POINTER(pa_autoload_info), c_int, c_void_p
)
pa_context_get_autoload_info_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_get_autoload_info_by_index = _libraries[
    "libpulse.so.0"
...
pa_context_get_autoload_info_list = _libraries[
    "libpulse.so.0"
...
pa_context_remove_autoload_by_name = _libraries[
    "libpulse.so.0"
...
pa_context_remove_autoload_by_index = _libraries[
    "libpulse.so.0"
...
pa_io_event_destroy_cb_t = CFUNCTYPE(
    None, POINTER(pa_mainloop_api), POINTER(pa_io_event), c_void_p
)
pa_time_event._fields_ = []
pa_time_event_destroy_cb_t = CFUNCTYPE(
    None, POINTER(pa_mainloop_api), POINTER(pa_time_event), c_void_p
)
...
pa_defer_event_cb_t = CFUNCTYPE(
    None, POINTER(pa_mainloop_api), POINTER(pa_defer_event), c_void_p
)
...
pa_mainloop_api._fields_ = [
    ...
    (
        "io_set_destroy",
        CFUNCTYPE(None, POINTER(pa_io_event), pa_io_event_destroy_cb_t),
    ),
    (
        "time_new",
        CFUNCTYPE(
    ...
    (
        "time_set_destroy",
        CFUNCTYPE(None, POINTER(pa_time_event), pa_time_event_destroy_cb_t),
    ),
    (
        "defer_new",
        CFUNCTYPE(
            POINTER(pa_defer_event),
            POINTER(pa_mainloop_api),
            pa_defer_event_cb_t,
            c_void_p,
        ),
    ...
    (
        "defer_set_destroy",
        CFUNCTYPE(None, POINTER(pa_defer_event), pa_defer_event_destroy_cb_t),
    ),
...
pa_mainloop_api_once.argtypes = [
    POINTER(pa_mainloop_api),
    CFUNCTYPE(None, POINTER(pa_mainloop_api), c_void_p),
    c_void_p,
]
...
pa_signal_cb_t = CFUNCTYPE(
    None, POINTER(pa_mainloop_api), POINTER(pa_signal_event), c_int, c_void_p
)
pa_signal_destroy_cb_t = CFUNCTYPE(
    None, POINTER(pa_mainloop_api), POINTER(pa_signal_event), c_void_p
)
...
pa_signal_set_destroy.argtypes = [
...
pa_context_play_sample_with_proplist = _libraries[
    "libpulse.so.0"
...
pa_stream_event_cb_t = CFUNCTYPE(
    None, POINTER(pa_stream), STRING, POINTER(pa_proplist), c_void_p
)
...
pa_stream_set_overflow_callback = _libraries[
    "libpulse.so.0"
...
pa_stream_get_underflow_index = _libraries[
    "libpulse.so.0"
...
pa_stream_set_underflow_callback = _libraries[
    "libpulse.so.0"
...
pa_stream_set_started_callback = _libraries[
    "libpulse.so.0"
...
pa_stream_set_latency_update_callback = _libraries[
    "libpulse.so.0"
...
pa_stream_set_suspended_callback = _libraries[
    "libpulse.so.0"
...
pa_stream_set_buffer_attr_callback = _libraries[
    "libpulse.so.0"
...
pa_context_subscribe_cb_t = CFUNCTYPE(
    None, POINTER(pa_context), pa_subscription_event_type_t, uint32_t, c_void_p
)
...
pa_sw_cvolume_multiply_scalar = _libraries[
    "libpulse.so.0"
...
pa_cvolume_compatible_with_channel_map = _libraries[
    "libpulse.so.0"
...
pa_cvolume_get_balance.argtypes = [
    POINTER(pa_cvolume),
    POINTER(pa_channel_map),
]
...
PA_PROP_WINDOW_DESKTOP = (
    "window.desktop"  # Variable STRING '(const char*)"window.desktop"'
)
...
PA_PROP_WINDOW_X11_DISPLAY = (
    "window.x11.display"  # Variable STRING '(const char*)"window.x11.display"'
)
PA_PROP_DEVICE_VENDOR_ID = (
    "device.vendor.id"  # Variable STRING '(const char*)"device.vendor.id"'
)
PA_PROP_FILTER_SUPPRESS = (
    "filter.suppress"  # Variable STRING '(const char*)"filter.suppress"'
)
PA_PROP_FORMAT_CHANNEL_MAP = (
    "format.channel_map"  # Variable STRING '(const char*)"format.channel_map"'
)
...
PA_PROP_DEVICE_PRODUCT_ID = (
    "device.product.id"  # Variable STRING '(const char*)"device.product.id"'
)
...
PA_PROP_DEVICE_BUS_PATH = (
    "device.bus_path"  # Variable STRING '(const char*)"device.bus_path"'
)
...
PA_PROP_APPLICATION_PROCESS_ID = (
    "application.process.id"  # Variable STRING '(const char*)"application.process.id"'
)
PA_PROP_MEDIA_ICON_NAME = (
    "media.icon_name"  # Variable STRING '(const char*)"media.icon_name"'
)
...
PA_PROP_APPLICATION_ICON_NAME = (
    "application.icon_name"  # Variable STRING '(const char*)"application.icon_name"'
)
PA_PROP_MODULE_VERSION = (
    "module.version"  # Variable STRING '(const char*)"module.version"'
)
...
PA_PROP_WINDOW_X11_SCREEN = (
    "window.x11.screen"  # Variable STRING '(const char*)"window.x11.screen"'
)
PA_USEC_INVALID = long(18446744073709551615)  # Variable c_ulong '-1u'
PA_PROP_APPLICATION_LANGUAGE = (
    "application.language"  # Variable STRING '(const char*)"application.language"'
)
PA_PROP_WINDOW_WIDTH = "window.width"  # Variable STRING '(const char*)"window.width"'
PA_PROP_DEVICE_STRING = (
    "device.string"  # Variable STRING '(const char*)"device.string"'
)
...
PA_PROP_EVENT_MOUSE_VPOS = (
    "event.mouse.vpos"  # Variable STRING '(const char*)"event.mouse.vpos"'
)
PA_PROP_MEDIA_ARTIST = "media.artist"  # Variable STRING '(const char*)"media.artist"'
PA_PROP_MEDIA_SOFTWARE = (
    "media.software"  # Variable STRING '(const char*)"media.software"'
)
PA_PROP_APPLICATION_ID = (
    "application.id"  # Variable STRING '(const char*)"application.id"'
)
...
PA_PROP_WINDOW_X11_XID = (
    "window.x11.xid"  # Variable STRING '(const char*)"window.x11.xid"'
)
PA_VOLUME_NORM = long(65536)  # Variable c_uint '65536u'
PA_PROP_EVENT_MOUSE_BUTTON = (
    "event.mouse.button"  # Variable STRING '(const char*)"event.mouse.button"'
)
...
PA_PROP_APPLICATION_ICON = (
    "application.icon"  # Variable STRING '(const char*)"application.icon"'
)
PA_PROP_WINDOW_X11_MONITOR = (
    "window.x11.monitor"  # Variable STRING '(const char*)"window.x11.monitor"'
)
PA_STREAM_EVENT_REQUEST_CORK = (
    "request-cork"  # Variable STRING '(const char*)"request-cork"'
)
PA_PROP_MEDIA_FILENAME = (
    "media.filename"  # Variable STRING '(const char*)"media.filename"'
)
PA_PROP_FORMAT_SAMPLE_FORMAT = (
    "format.sample_format"  # Variable STRING '(const char*)"format.sample_format"'
)
...
PA_PROP_EVENT_MOUSE_X = (
    "event.mouse.x"  # Variable STRING '(const char*)"event.mouse.x"'
)
PA_SAMPLE_SPEC_SNPRINT_MAX = 32  # Variable c_int '32'
PA_PROP_EVENT_MOUSE_Y = (
    "event.mouse.y"  # Variable STRING '(const char*)"event.mouse.y"'
)
...
PA_PROP_EVENT_DESCRIPTION = (
    "event.description"  # Variable STRING '(const char*)"event.description"'
)
PA_PROP_DEVICE_ACCESS_MODE = (
    "device.access_mode"  # Variable STRING '(const char*)"device.access_mode"'
)
PA_PROP_EVENT_MOUSE_HPOS = (
    "event.mouse.hpos"  # Variable STRING '(const char*)"event.mouse.hpos"'
)
PA_PROP_DEVICE_MASTER_DEVICE = (
    "device.master_device"  # Variable STRING '(const char*)"device.master_device"'
)
PA_PROP_FORMAT_RATE = "format.rate"  # Variable STRING '(const char*)"format.rate"'
PA_PROP_DEVICE_PROFILE_NAME = (
    "device.profile.name"  # Variable STRING '(const char*)"device.profile.name"'
)
PA_STREAM_EVENT_REQUEST_UNCORK = (
    "request-uncork"  # Variable STRING '(const char*)"request-uncork"'
)
PA_PROP_EVENT_ID = "event.id"  # Variable STRING '(const char*)"event.id"'
PA_BYTES_SNPRINT_MAX = 11  # Variable c_int '11'
PA_PROP_DEVICE_FORM_FACTOR = (
    "device.form_factor"  # Variable STRING '(const char*)"device.form_factor"'
)
...
PA_PROP_FORMAT_CHANNELS = (
    "format.channels"  # Variable STRING '(const char*)"format.channels"'
)
...
PA_PROP_DEVICE_SERIAL = (
    "device.serial"  # Variable STRING '(const char*)"device.serial"'
)
PA_STREAM_EVENT_FORMAT_LOST = (
    "format-lost"  # Variable STRING '(const char*)"format-lost"'
)
PA_PROP_APPLICATION_VERSION = (
    "application.version"  # Variable STRING '(const char*)"application.version"'
)
PA_PROP_DEVICE_PRODUCT_NAME = (
    "device.product.name"  # Variable STRING '(const char*)"device.product.name"'
)
PA_PROP_MODULE_AUTHOR = (
    "module.author"  # Variable STRING '(const char*)"module.author"'
)
PA_PROP_WINDOW_ICON_NAME = (
    "window.icon_name"  # Variable STRING '(const char*)"window.icon_name"'
)
PA_MAJOR = 1  # Variable c_int '1'
PA_MSEC_PER_SEC = long(1000)  # Variable c_ulong '1000u'
PA_PROP_DEVICE_VENDOR_NAME = (
    "device.vendor.name"  # Variable STRING '(const char*)"device.vendor.name"'
)
PA_PROP_DEVICE_INTENDED_ROLES = (
    "device.intended_roles"  # Variable STRING '(const char*)"device.intended_roles"'
)
PA_SW_CVOLUME_SNPRINT_DB_MAX = 448  # Variable c_int '448'
PA_PROP_DEVICE_DESCRIPTION = (
    "device.description"  # Variable STRING '(const char*)"device.description"'
)
PA_PROP_APPLICATION_NAME = (
    "application.name"  # Variable STRING '(const char*)"application.name"'
)
PA_PROP_DEVICE_ICON_NAME = (
    "device.icon_name"  # Variable STRING '(const char*)"device.icon_name"'
)
PA_PROP_MODULE_DESCRIPTION = (
    "module.description"  # Variable STRING '(const char*)"module.description"'
)
...
PA_PROP_WINDOW_HEIGHT = (
    "window.height"  # Variable STRING '(const char*)"window.height"'
)
PA_PROP_MEDIA_COPYRIGHT = (
    "media.copyright"  # Variable STRING '(const char*)"media.copyright"'
)
PA_SW_VOLUME_SNPRINT_DB_MAX = 10  # Variable c_int '10'
PA_PROP_MEDIA_LANGUAGE = (
    "media.language"  # Variable STRING '(const char*)"media.language"'
)
pollfd._fields_ = []
__all__ = [
    "pa_context_set_name",
